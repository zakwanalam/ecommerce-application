...
function Hero(props) {
  return (
    <>
      ...
      >
        <div className="w-[540px] mt-11 max-lg:hidden  aspect-square top-[50%] translate-y-[-45%] right-36 rounded-full absolute bg-[#fd5f38]"></div>
        <img
          id="hero-image"
          src={shoes}
        ...
        <div  className="heroBackground"></div>
          <div className="heroText">
            <div className="absolute container max-lg:hidden flex w-full lg:w-[50%] h-full flex-col items-start lg:left-24 xl:left-48 justify-center max-lg:items-center max-lg:left-0">
