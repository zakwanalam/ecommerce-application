...
function Product(props) {
  ...
  return (
    <div id="product" className="transition-all duration-300 hover:scale-105">
      ...
      >
        <div
          className=" mx-3  relative mt-3 flex h-64 overflow-hidden cursor-pointer rounded-xl"
          onClick={() => {
        ...
        <div className="mt-4 px-5 pb-5">
          ...
          <a
            ...
            className="flex cursor-pointer items-center justify-center rounded-md bg-indigo-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-indigo-500 focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
